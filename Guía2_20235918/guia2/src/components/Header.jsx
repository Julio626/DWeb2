...
export function Header({cart, total, increaseProductQuantity, decreaseProductQuantity, removeProduct, emptyCart}){
                                        ...
                                        <tr key={guitar.id}>
                                            ...
                                            <td className="flex align-items-start gap-4"> 
                                                <button
                                                    ...
                                                    onClick={()=> decreaseProductQuantity(guitar.id)}
                                                >
                                                    -
                                                </button>
                                                    {guitar.quantity}
                                                <button
                                                    type="button"
                                                    className="btn btn-dark"
                                                    onClick={()=> increaseProductQuantity(guitar.id)}
                                                >
                                                    +
                                                </button>
                                            </td>
